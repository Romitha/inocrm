...
namespace :tire do
  ...
  task index_all_model: :environment do
    [['Grn'], ['GrnItem', 'Grn'], ['InventoryProduct', 'Inventory'], ['InventorySerialItem', 'Inventory'], ['Product'], ['Ticket'], ['InventoryPrn', 'Inventory'], ['InventoryPo', 'Inventory'], ['Organization']].each do |models|
