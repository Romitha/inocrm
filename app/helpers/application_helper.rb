module ApplicationHelper
  ...
  def print_ticket_tag_value ticket
    [
      ...
      "EXTRA_REMARK1=#{ticket.ticket_extra_remarks.first.try(:extra_remark)}",
      "EXTRA_REMARK2=#{ticket.ticket_extra_remarks.second.try(:extra_remark)}",
      "EXTRA_REMARK3=#{ticket.ticket_extra_remarks.third.try(:extra_remark)}",
      "EXTRA_REMARK4=#{ticket.ticket_extra_remarks.fourth.try(:extra_remark)}",
      "EXTRA_REMARK5=#{ticket.ticket_extra_remarks.fifth.try(:extra_remark)}",
      "EXTRA_REMARK6=",
