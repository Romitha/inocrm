module TicketsHelper
  ...
  def send_email(*args)
    ...
    if spare_part.present?
      ...
      spare_part_info = {spare_part_no: spare_part.spare_part_no, spare_part_name: spare_part.spare_part_description, spare_part_type: spare_part_type, spare_part_event_no: spare_part.ticket_spare_part_manufacture.try(:event_no)}
