window.Tickets =
  ...
  call_resolution_template: (call_template)->
    ...
    $("#template_caller").change ->
      _this.ajax_loader()
      $.post "/tickets/call_resolution_template", {call_template: $(@).val(), task_id: $(":selected", @).data("task-id"), process_id: $(":selected", @).data("process-id"), engineer_id: $(":selected", @).data("engineer-id")}
  ...
  select_fsr: ->
    $("#select_fsr").change ->
      $.post "/tickets/call_resolution_template", {call_template: "edit_fsr", select_fsr_id: $(":selected", @).val(), task_id: $(":selected", @).data("taskid")}
