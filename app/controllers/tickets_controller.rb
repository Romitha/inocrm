...
#        Set Action:(66) Reject Close Ticket, and  DB.spt_act_ticket_close_approve 
  ...
  private
    ...
    def ticket_fsr_params
      ticket_fsr_params = params.require(:ticket_fsr).permit(:form_no, :travel_hours, :work_started_at, :work_finished_at, :office_out_at, :office_in_at, :hours_worked, :down_time, :engineer_time_travel, :engineer_time_on_site, :resolution, :completion_level, :remarks, :ticket_id, ticket_attributes: [:remarks, :id], ticket_fsr_support_engineers_attributes: [:id ,:engineer_support_id, :hours_worked])
