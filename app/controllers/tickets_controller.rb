  ...
  def ticket_update
    ...
    respond_to do |format|
      if @ticket.valid?
        ...
        if params[:ticket][:ticket_logged_at].present?
          @ticket.errors.clear
          Rails.cache.write([:new_ticket, request.remote_ip.to_s, session[:time_now]], @ticket)
