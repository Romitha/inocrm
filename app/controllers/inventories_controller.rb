      ...
      if not params[:update_without_return]
        if continue
          ...
          if (manufacture_warranty or manufacture_chargeable) and (rce or rpr)
            ...
            query = {ticket_id: ticket_id, request_spare_part_id: request_spare_part_id, supp_engr_user: supp_engr_user, priority: priority, d47_bundle_only: "N", d48_deliver_bundle: "Y"}
