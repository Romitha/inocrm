class InventoriesController < ApplicationController
  ...
  private
    ...
    def estimation_params
      estimation_params = params.require(:ticket_estimation).permit(:note, :id, :cust_approved, :cust_approved_by, :advance_payment_amount, :current_user_id, :approved_adv_pmnt_amount, ticket_estimation_parts_attributes: [:id, :supplier_id, :cost_price, :estimated_price, :warranty_period, :approved_estimated_price, ticket_estimation_part_taxes_attributes: [:id, :_destroy, :tax_id, :tax_rate, :estimated_tax_amount, :approved_tax_amount], ticket_spare_part_attributes: [:note, :id, :current_user_id]], ticket_estimation_additionals_attributes: [:id, :_destroy, :ticket_id, :additional_charge_id, :cost_price, :estimated_price, :approved_estimated_price, ticket_estimation_additional_taxes_attributes: [:id, :_destroy, :tax_id, :tax_rate, :estimated_tax_amount, :approved_tax_amount]])
