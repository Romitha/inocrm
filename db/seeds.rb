...
spare_part_status_action = [
  ...
  ["RTN", "Part Returned by Engineer", 7,10,5,0,5,0,0, 'Part To Be Returned By Engineer'],
  ["RPR", "Returned Part Rejected", 8,11,6,0,6,0,0, 'Accept or Reject The Returned Part'],
  ...
  ["STR", "Requested from Store", 0,0,1,4,1,0,0, 'Request From Store'],
  ["APS", "Store Request Approved", 0,0,2,5,2,0,0, 'Approve or Reject The Store Request'],
  ["RJS", "Store Request Rejected", 0,0,2,5,2,0,0, 'Approve or Reject The Store Request'],
