class ModifyRolesRelatedTables < ActiveRecord::Migration
  def change
    ...
    #   t.string :name
    #   t.string :value
    #   t.column :rpermission_id, "INT UNSIGNED"
    #   t.timestamps
    # end
    ...
    # add_index :subject_attributes, :rpermission_id, name: "fk_main_permissions_main_permissions1_idx"
    # add_index :subject_actions, :rpermission_id, name: "fk_subject_actions_main_permissions1_idx"
    ...
    add_foreign_key(:subject_attributes, :rpermissions, name: "fk_main_permissions_main_permissions2", column: :rpermission_id)
    add_foreign_key(:subject_actions, :rpermissions, name: "fk_main_permissions_main_permissions1", column: :rpermission_id)
