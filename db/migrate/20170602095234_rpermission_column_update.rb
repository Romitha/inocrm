class RpermissionColumnUpdate < ActiveRecord::Migration
  def change
    ...
    # remove_foreign_key :subject_attributes, name: :fk_main_permissions_main_permissions2 tmp
    # remove_index :rpermissions, name: :fk_main_permissions_main_permissions2_idx
    # remove_column :rpermissions, :subject_attribute_id

    # remove_foreign_key :subject_actions, name: :fk_main_permissions_main_permissions1 tmp
    ...
    # add_foreign_key :subject_actions, :rpermissions, name: "fk_subject_actions_rpermissions", column: :rpermission_id tmp
    ...
    execute "SET FOREIGN_KEY_CHECKS = 0"
    # add_foreign_key :subject_attributes, :rpermissions, name: "fk_subject_attributes_rpermissions", column: :rpermission_id tmp
    execute "SET FOREIGN_KEY_CHECKS = 1"
