God.watch do |w|
  ...
  w.start = "/usr/local/rvm/bin/rvm ruby-2.2.0@rails_4_2_1 do bundle exec rake -f Rakefile backburner:work RAILS_ENV=production QUEUE=backburner-jobs,index-model"
  w.log   = "/var/log/backburner-worker-1.log"
